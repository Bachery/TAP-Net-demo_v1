...
def load_data(data_file, blocks_num, data_size):
    '''
    Data initialization
    ----
    params
...
def valid(actor, data_size, blocks_num, heightmap_type, checkpoint_path, use_cuda, save_dir):
    ...
    blocks, _, _, _ = load_data('./data/gt_2d/pack-valid-%d-%d-5-1-5/' % (blocks_num, data_size), blocks_num, data_size)
