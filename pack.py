...
class PACKDataset(Dataset):
    def __init__(self, data_file, blocks_num, num_samples, seed, input_type, heightmap_type, allow_rot, container_width, mix_data_file=None, unit=1):
        '''
        Data initialization
        ----
        params
...
def reward(static, tour_indices, reward_type, input_type, allow_rot, container_width, container_height, packing_strategy='LB_GREEDY'):
    """
    已弃用。后面加入高度图后，container类一直更新packing结果，网络可以直接输出分数
    --------------
    Parameters
    ----------
